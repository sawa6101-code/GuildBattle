...
(function(){
 ...
 async function prepare(v){if(v==='battle')return ensureBattle();if(v==='characters')return ensureCharacters();if(v==='import'){await loadScript('phase3.js');return ensureOCR()}}
 document.addEventListener('click',async e=>{
   if(replaying)return;
   const b=e.target.closest('[data-view]');if(!b)return;
   const v=b.dataset.view;if(!['battle','characters','import'].includes(v))return;
