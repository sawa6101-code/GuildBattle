const CACHE='guildbattle-v12';
const ASSETS=['./','./index.html','./style.css','./app.js','./lazy-load.js','./manifest.json','./character_master_catalog_20260918.js','./help.js','./phase4_2_character_master.js','./enemy_guild_seed_20260918.js','./own_players_seed_20260918.js','./party_seed_kuroronkotarezo_20260918.js','./persistent_recovery_seed.js','./character_match_engine.js','./character_match_audit.js'];
